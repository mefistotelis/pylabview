The LabView Resource File (RSRC) is a container used for both Virtual Instruments (VI) files, and LabView Library (LLB) files. Inside the RSRC container, various blocks are stored.
