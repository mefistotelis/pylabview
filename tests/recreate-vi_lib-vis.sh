...
SRC_VI_DIRS='../lv06 ./lv06 ../lv07 ./lv07 ../lv14 ./lv14'
...
find ${SRC_VI_DIRS} -type f -iname '*.vi' -o -iname '*.ctl' -o -iname '*.vit' -o -iname '*.mnu' -o -iname '*.ctt' -o -iname '*.uir' | tee log-vi_lib-vi-0list.txt
